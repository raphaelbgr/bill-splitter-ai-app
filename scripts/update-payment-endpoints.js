...
// List of payment endpoints to update
...
// Template for updated payment endpoints
const paymentEndpointTemplate = (endpointName) => {
...
// Update each payment endpoint
paymentEndpoints.forEach(endpointPath => {
  ...
  const content = paymentEndpointTemplate(endpointName);
  fs.writeFileSync(fullPath, content);
  console.log(`Updated: ${endpointPath}`);
});

console.log('All payment endpoints updated successfully!'); 